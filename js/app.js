...
if (window.location.host !== "objectpath.github.io/ObjectPath")
	window.location = "http://objectpath.github.io/ObjectPath/"+window.location.pathname.split("/").slice(2).join("/")
